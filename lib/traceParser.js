...
class TraceParser {
    ...
    detectCallbackType(methodName, contractAddress, callData) {
        ...
        if (method.includes('flashloan') || method.includes('flashLoan') || method.includes('executeOperation')) {
                            ...
                            if (invocation.selector) {
                                try {
                                    ...
                                    if (apiResult) {
                                        ...
                                        // Mark as decoded since we have function name and signature from API
                                        apiDecoded = true;
    ...
    toChecksumAddress(address) {
        ...
        try {
            // Use ethers built-in getAddress for proper checksumming
